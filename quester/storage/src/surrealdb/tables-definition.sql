...
DEFINE FIELD id ON TABLE semantic_knowledge TYPE integer;
...
DEFINE FIELD id ON TABLE embedded_knowledge TYPE integer AUTO INCREMENT;
DEFINE FIELD embeddings ON TABLE embedded_knowledge TYPE list;
...
DEFINE FIELD id ON TABLE discovered_knowledge TYPE integer AUTO INCREMENT;
...
DEFINE FIELD query_embedding ON TABLE discovered_knowledge TYPE list;
