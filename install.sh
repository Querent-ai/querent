...
PACKAGE_ROOT="${PACKAGE_ROOT:-"https://github.com/querent-ai/querent/releases/download"}"
PACKAGE_RELEASE_API="${PACKAGE_RELEASE_API:-"https://api.github.com/repos/querent-ai/querent/releases"}"
...
usage() {
    cat 1>&2 <<EOF
querent-install
The installer for Querent (https://querent.xyz/)

USAGE:
    querent-install [FLAGS] [OPTIONS]
...
install_from_archive() {
    ...
    case "$_arch" in
        ...
        *)
            ...
            printf "\n"
            err "You can easily build it from source following the docs: https://docs.querent.xyz/"
            ;;
    esac
