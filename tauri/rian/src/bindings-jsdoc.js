...
/**
 * Insight Information.
 * @typedef { { id: string; name: string; description: string; version: string; conversational: boolean; author: string; license: string; icon: number[]; additionalOptions: { [key in string]: CustomInsightOption }; premium: boolean } } InsightInfo
 */
