...
impl XAIOllama {
	pub fn new() -> Self {
        ...
        Make sure it is written in third person, and make sure we have the full context.".to_string(),
				...
				tooltip: Some("Custom prompt for generating insights. If provided, this prompt will be used instead of the default prompt to generate a summary of results using Ollama. This free tool does not parse the actual documents but materializes responses using data fabric as a guardrails for llm.".to_string()),
